CREATE TABLE Accion (IDAccion  SERIAL NOT NULL, NOMBRE VARCHAR(255), SYMBOL VARCHAR(255), VALORACTUAL FLOAT, PRIMARY KEY (IDAccion))
CREATE TABLE Administrador (IDUsuario  SERIAL NOT NULL, Nombre VARCHAR(255), Password VARCHAR(255), PRIMARY KEY (IDUsuario))
CREATE TABLE Cliente (IDUsuario  SERIAL NOT NULL, IDTELEFONO VARCHAR(255) UNIQUE, PORTAFOLIO_IDPortafolio BIGINT, PRIMARY KEY (IDUsuario))
...
CREATE TABLE PreguntaGeneral (IDPreg BIGINT NOT NULL, PRIMARY KEY (IDPreg))
CREATE TABLE Paquete (IDPaq  SERIAL NOT NULL, Paquete_Tipo VARCHAR(31), NOMBRE VARCHAR(255), PRIMARY KEY (IDPaq))
CREATE TABLE PaqueteAlgoritmico (IDPaq BIGINT NOT NULL, ALGORITMO VARCHAR(255), DISPONIBLE FLOAT, FECHACALCULO TIMESTAMP, INVERSION FLOAT, PRIMARY KEY (IDPaq))
...
CREATE TABLE Portafolio (IDPortafolio  SERIAL NOT NULL, SININVERTIR FLOAT, ULTIMAFECHASALDO TIMESTAMP, ULTIMOSALDO FLOAT, PRIMARY KEY (IDPortafolio))
...
CREATE TABLE portafolio_saldohistorico (ID  SERIAL NOT NULL, saldohistorico_key TIMESTAMP, saldohistorico FLOAT NOT NULL, portafolio_idportafolio BIGINT, PRIMARY KEY (ID))
