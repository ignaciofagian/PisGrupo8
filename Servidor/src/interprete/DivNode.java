...
public class DivNode implements PSNode {

    private PSNode lhs;
    private PSNode rhs;

    public DivNode(PSNode lhs, PSNode rhs) {
        this.lhs = lhs;
        this.rhs = rhs;
    }
    ...
    public PSValue evaluate(long idPaquete, Calendar fecha, IInterpreter intepr) {
        ...
        if(a.isNumber() && b.isNumber()) {
            ...
            return new PSValue(a.asDouble() / b.asDouble());      //SI ES DIV 0, CONTROALRLO YO Y TIRAR EXCEPCION
        }
